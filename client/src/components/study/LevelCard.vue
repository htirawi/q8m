<template>
  ...
  >
    ...
    <div v-else-if="isSelected && !isLocked" class="absolute right-4 top-4 z-10" aria-hidden="true">
      <div
...
const description = computed(() =>
  planConfig.value
    ? t(planConfig.value.descriptionKey)
    : t(`difficulty.${props.difficulty}.description`)
);
