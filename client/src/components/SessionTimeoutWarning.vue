  ...
  <div v-if="showWarningDialog" class="session-timeout-overlay">
    <div class="session-timeout-modal">
      <div class="session-timeout-header">
        ...
        <h3 class="session-timeout-title">{{ t("sessionTimeout.title") }}</h3>
      </div>
...
.session-timeout-modal {
  @apply rounded-2xl bg-white shadow-2xl dark:bg-gray-800;
  @apply mx-4 w-full max-w-md p-6;
  @apply animate-pulse;
}
...
.btn {
  @apply flex-1 rounded-lg px-4 py-2 font-medium transition-all;
