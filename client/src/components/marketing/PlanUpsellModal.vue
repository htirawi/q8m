  ...
  <Teleport to="body">
    <Transition name="modal-fade">
      ...
      >
        ...
        <div
          ref="modalRef"
          class="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white shadow-2xl dark:bg-gray-800"
          tabindex="-1"
        ...
        >
          ...
          <button
            type="button"
            class="absolute right-4 top-4 z-10 rounded-lg p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:ring-offset-gray-800"
          ...
          <div class="px-8 py-6">
            ...
            <!-- Trust signals -->
            <div
              class="mt-6 flex items-center justify-center gap-6 border-t border-gray-200 pt-4 text-xs text-gray-500 dark:border-gray-700 dark:text-gray-400"
            >
...
import type {
  IPlanUpsellModalProps as Props,
...
const difficultyLabel = computed(() =>
  difficultyPlanConfig.value
    ? t(difficultyPlanConfig.value.labelKey)
    : t(`difficulty.${props.difficulty}.label`)
);
