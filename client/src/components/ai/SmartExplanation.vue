          ...
          <div v-if="explanation.examples?.length" class="explanation-section">
            ...
            <div class="explanation-section__content">
              ...
              >
                ...
                <pre class="code-example__code"><code :class="`language-${example.language}`">{{ example.code }}</code></pre>
                <div v-if="example.explanation" class="code-example__explanation">
                  {{ example.explanation }}
                </div>
                <div v-if="example.output" class="code-example__output">
                  <span class="code-example__output-label">{{ $t('ai.output') }}:</span>
                ...
                >
                  ...
                  <div class="resource-item__content">
                    ...
                    <div class="resource-item__meta">
                      ...
                      <span v-if="resource.free" class="resource-item__badge">{{ $t('common.free') }}</span>
...
console.log(result);`,
      explanation: 'This shows the most basic implementation pattern.',
...
class AdvancedExample implements ExampleInterface {
  ...
  process(): void {
    console.log(\`Processing \${this.name} with value \${this.value}\`);
      ...
      explanation: 'A more complex example showing TypeScript integration.'
    }
  ],
  ...
  practiceProblems: [
    {
      id: 'p1',
      question: `Implement a simple ${props.concept} that handles user data`,
      difficulty: 'easy',
      hints: ['Start with the basic structure', 'Consider data validation'],
  ...
  resources: [
    {
      type: 'video',
      title: `Understanding ${props.concept} - Complete Guide`,
      url: 'https://example.com/video',
      description: 'A comprehensive video tutorial covering all aspects',
      duration: '45 min',
      free: true,
      recommended: true
    },
...
const showHint = (problemId: string) => {
  ...
  if (problem?.hints) {
    const currentHintIndex = hints.value[problemId] ? problem.hints.indexOf(hints.value[problemId]) : -1;
