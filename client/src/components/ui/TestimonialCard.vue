    ...
    <figure class="testimonial-card" :data-testimonial-id="testimonial.id">
        ...
        <figcaption class="testimonial-card__author">
            <div class="testimonial-card__avatar-wrapper">
                <img v-if="testimonial.avatarUrl" :src="testimonial.avatarUrl" :alt="t(testimonial.nameKey)"
                    class="testimonial-card__avatar" loading="lazy" width="48" height="48" />
            ...
            <div v-if="testimonial.rating" class="testimonial-card__rating"
                ...
                <svg v-for="star in testimonial.rating" :key="star" class="testimonial-card__star" fill="currentColor"
...
.testimonial-card__name {
    @apply block text-sm font-bold text-slate-900 not-italic dark:text-white;
}
