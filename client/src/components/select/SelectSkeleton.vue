...
.skeleton-base {
  @apply rounded-lg bg-white/20 backdrop-blur-sm;
...
/* Header skeleton */
.skeleton-header {
  @apply mb-20 py-12 text-center;
}

.skeleton-title {
  @apply skeleton-base mx-auto mb-6 h-16 w-96 max-w-full;
  @apply rounded-2xl;
}

.skeleton-subtitle {
  @apply skeleton-base mx-auto h-8 w-[600px] max-w-full;
  @apply rounded-xl;
}

/* Grid skeleton */
.skeleton-grid {
  @apply mb-16 grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-8 lg:grid-cols-4;
}
...
.skeleton-card__badge {
  @apply skeleton-base absolute right-4 top-4 h-6 w-16;
  @apply rounded-full;
}
...
.skeleton-card__cta {
  @apply skeleton-base mt-2 h-12 w-full rounded-xl;
}
