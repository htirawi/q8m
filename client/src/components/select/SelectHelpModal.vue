    ...
    <Teleport to="body">
        <Transition name="modal-fade">
            <div v-if="modelValue" class="modal-overlay" role="dialog" aria-modal="true"
                :aria-labelledby="`modal-title-${uid}`" @click.self="handleClose" @keydown.esc="handleClose">
                <div class="modal-container" role="document">
                    <!-- Close button -->
                    <button type="button" class="modal-close" :aria-label="$t('select.closeHelp')" @click="handleClose">
                    ...
                    <div class="modal-content">
                            ...
                            <div v-for="level in levels" :key="level.id" class="level-card"
                                ...
                                <div class="level-card__header">
                                    <div class="level-card__icon" :class="`level-card__icon--${level.id}`">
                                        <svg v-if="level.id === 'junior'" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                        </svg>
                                        <svg v-else-if="level.id === 'intermediate'" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13 10V3L4 14h7v7l9-11h-7z" />
                                        </svg>
                                        <svg v-else-if="level.id === 'senior'" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <!-- Card content -->
                                <p class="level-card__description">{{ $t(level.descriptionKey) }}

</p>

                                <!-- Features list -->
                                <ul class="level-card__features">
                                    <li v-for="(feature, idx) in level.features" :key="idx" class="level-card__feature">
                                        <svg class="feature-check" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M5 13l4 4L19 7" />
                                        </svg>
                        ...
                        <div class="trust-indicator">
                            ...
                            <p class="trust-text">{{ $t('select.helpNote') }}
