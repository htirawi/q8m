<template>
    <footer class="select-footer">
        <div class="select-footer__actions">
            <!-- Primary CTA -->
            <button type="button" class="select-footer__btn select-footer__btn--primary"
                :disabled="!hasSelection || isNavigating" :aria-label="$t('select.continueAriaLabel')"
                @click="handleContinue">
                <span v-if="!isNavigating">{{ $t('select.continue') }}
            ...
            <button v-if="canSkip" type="button" class="select-footer__btn select-footer__btn--secondary"
                :aria-label="$t('select.skipAriaLabel')" @click="handleSkip">
                {{ $t('select.skip') }}
...
<style scoped>
.select-footer {
    @apply flex flex-col items-center gap-6 mt-12 mb-8;
...
/* Buttons */
.select-footer__btn {
    @apply relative px-12 py-5 rounded-2xl font-extrabold text-lg;
...
.select-footer__btn--primary {
    ...
    box-shadow: 0 20px 50px -10px rgb(0, 0, 0, 0.4), 0 0 0 1px rgb(255, 255, 255, 0.2),
        inset 0 1px 0 0 rgb(255, 255, 255, 0.8), inset 0 -1px 0 0 rgb(0, 0, 0, 0.05);
...
.select-footer__btn--primary:not(:disabled):hover {
    ...
    box-shadow: 0 30px 70px -12px rgb(0, 0, 0, 0.5), 0 0 0 2px rgb(255, 255, 255, 0.3),
        inset 0 2px 0 0 rgb(255, 255, 255, 1), inset 0 -2px 0 0 rgb(0, 0, 0, 0.08), 0 0 40px rgb(255, 255, 255, 0.4);
}
...
.select-footer__btn--secondary {
    ...
    box-shadow: 0 12px 35px -8px rgb(0, 0, 0, 0.3), inset 0 1px 0 0 rgb(255, 255, 255, 0.2);
...
.select-footer__btn--secondary:not(:disabled):hover {
    ...
    box-shadow: 0 16px 45px -8px rgb(0, 0, 0, 0.4), inset 0 1px 0 0 rgb(255, 255, 255, 0.3);
}
...
.help-link {
    @apply text-white/80 hover:text-white text-sm font-medium underline underline-offset-4;
