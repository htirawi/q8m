    ...
    <div class="faq-section__container">
      ...
      <div class="faq-section__features">
        ...
        <div class="faq-section__search">
          <div class="faq-section__search-wrapper">
            ...
            <input
              v-model="searchQuery"
              type="text"
              :placeholder="t('home.faq.search.placeholder')"
        ...
        <div class="faq-section__categories">
          ...
          >
            ...
            <span class="faq-section__category-count">{{ getCategoryCount(category.id) }} </span>
          </button>
        </div>
      ...
      <div class="faq-section__accordion">
        ...
        <div v-if="filteredFaqs.length === 0" class="faq-section__no-results">
          <svg
            class="faq-section__no-results-icon"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div class="faq-section__support">
        <div class="faq-section__support-content">
          ...
          <div class="faq-section__support-actions">
            <button
              type="button"
              class="faq-section__support-button faq-section__support-button--primary"
            >
              <svg
                class="faq-section__support-icon"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <button
              type="button"
              class="faq-section__support-button faq-section__support-button--secondary"
            >
              <svg
                class="faq-section__support-icon"
                fill="none"
...
.faq-section__accordion {
  @apply overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800;
}
...
.faq-section__search-icon {
  @apply absolute left-4 z-10 h-5 w-5 text-gray-400;
}

.faq-section__search-input {
  @apply w-full rounded-2xl border-2 border-gray-200 py-4 pl-12 pr-12 dark:border-gray-700;
  @apply bg-white text-gray-900 dark:bg-slate-800 dark:text-white;
  @apply placeholder-gray-500 dark:placeholder-gray-400;
  @apply focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/20;
  @apply transition-all duration-300;
  @apply shadow-lg shadow-gray-200/50 dark:shadow-gray-900/50;
}

.faq-section__search-clear {
  @apply absolute right-4 rounded-full p-1 hover:bg-gray-100 dark:hover:bg-gray-700;
...
.faq-section__category {
  @apply flex items-center gap-2 rounded-full px-4 py-2;
  @apply text-sm font-medium text-gray-600 dark:text-gray-300;
  @apply border border-gray-200 bg-white dark:border-gray-700 dark:bg-slate-800;
...
.faq-section__no-results-icon {
  @apply mx-auto mb-4 h-16 w-16 text-gray-300 dark:text-gray-600;
}
...
.faq-section__support-description {
  @apply mx-auto mb-8 max-w-2xl text-blue-100;
}
...
.faq-section__support-button {
  @apply flex items-center gap-3 rounded-xl px-6 py-3 font-medium;
  @apply transition-all duration-200;
