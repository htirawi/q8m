    ...
    <section class="how-it-works-section" aria-labelledby="how-it-works-title">
        <div class="how-it-works-container">
            ...
            <div class="how-it-works-steps">
                <article v-for="(step, index) in steps" :key="step.id" class="how-it-works-step"
                    :data-step="step.stepNumber">
                    <!-- Step number badge -->
                    <div class="step-number">
                        <span class="step-number__text">{{ step.stepNumber }}
          ...
          <div class="step-icon">
            ...
            />
                    ...
                    <div v-if="index < steps.length - 1" class="step-connector" aria-hidden="true">
                        <svg class="step-connector__arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
