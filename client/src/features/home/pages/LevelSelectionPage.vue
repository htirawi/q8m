<template>
  ...
  >
      ...
      <div class="mb-12">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          >
            <div class="relative z-10">
              ...
              <div class="mb-6 flex justify-center">
                <div :class="getLevelIconClass('junior')">
              ...
              <div class="mb-6 space-y-2 text-sm">
                <div
                  ...
                  :class="
                    selectedLevel === 'junior' && canUserAccessLevel('junior')
                      ? 'text-white/90'
              ...
              <div class="flex justify-center">
                <span
                  v-if="canUserAccessLevel('junior')"
            ...
            >
              <div
                class="flex h-10 w-10 animate-scale-in items-center justify-center rounded-full bg-white shadow-lg"
              >
          ...
          <button
            ...
            @click="handleLevelClick('intermediate')"
          >
            <div class="relative z-10">
              <!-- Icon IBadge -->
              <div class="mb-6 flex justify-center">
                <div :class="getLevelIconClass('intermediate')">
                  <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <div class="mb-6 space-y-2 text-sm">
                <div
                  class="flex items-center gap-2"
                  :class="
                    selectedLevel === 'intermediate' && canUserAccessLevel('intermediate')
                      ? 'text-white/90'
                      : 'text-gray-600 dark:text-gray-400'
                  "
                >
              ...
              <div class="flex justify-center">
                <span
                  v-if="canUserAccessLevel('intermediate')"
          ...
          >
            <div class="relative z-10">
              <!-- Icon IBadge -->
              <div class="mb-6 flex justify-center">
                <div :class="getLevelIconClass('senior')">
                  <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <div class="mb-6 space-y-2 text-sm">
                <div
                  class="flex items-center gap-2"
                  :class="
                    selectedLevel === 'senior' && canUserAccessLevel('senior')
                      ? 'text-white/90'
                      : 'text-gray-600 dark:text-gray-400'
                  "
                >
              ...
              <div class="flex justify-center">
                <span
                  v-if="canUserAccessLevel('senior')"
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-800"
        >
          <button
...
onMounted(async () => {
  if (authStore.isAuthenticated) {
    await Promise.all([fetchStreak(), fetchCoins()]);
  }
...
const getLevelCardClass = (level: ExperienceLevel) => {
  ...
  const baseClass =
    "group relative overflow-hidden rounded-3xl border-2 p-8 text-left transition-all duration-500 transform cursor-pointer";
