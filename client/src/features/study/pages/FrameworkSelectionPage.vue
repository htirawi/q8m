    ...
    <div class="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-12">
      ...
      <div class="animation-delay-200 mb-12 animate-fade-in-up text-center">
        ...
        <div class="mb-6">
          ...
          <p
            class="mx-auto max-w-2xl px-2 text-sm leading-relaxed text-gray-600 dark:text-gray-300 sm:px-0 sm:text-base md:text-lg"
            role="status"
            aria-live="polite"
          >
            Master
      ...
      <div v-if="isLoading" class="animation-delay-400 animate-fade-in-up">
        <div class="mb-6 text-center">
          <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Loading frameworks...</p>
        </div>
      ...
      <div class="animation-delay-600 mt-8 animate-fade-in-up text-center sm:mt-12">
        ...
        >
          ...
          <h3
            class="mb-1.5 text-base font-semibold text-gray-900 dark:text-white sm:mb-2 sm:text-lg"
          >
            Not sure which framework to choose?
          </h3>
          <p class="text-xs text-gray-600 dark:text-gray-400 sm:text-sm">
            Select
            <span class="font-semibold text-purple-600 dark:text-purple-400">Random Mix</span> to
            practice questions from all frameworks. You can switch anytime!
          </p>
        </div>
      </div>
    </div>
