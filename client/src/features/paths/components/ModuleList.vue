  ...
  <div class="space-y-3">
    ...
    >
      <div class="flex items-start justify-between">
        ...
        <div class="ml-4">
          <span v-if="isModuleCompleted(module.moduleId)" class="text-green-600 dark:text-green-400">
            ✓
          </span>
          <span v-else-if="module.isLocked" class="text-gray-400 dark:text-gray-600">
            🔒
          </span>
          <span v-else-if="isCurrentModule(module.moduleId)" class="text-primary-600 dark:text-primary-400">
            ▶
          </span>
        </div>
      </div>
