      ...
      <div class="container">
        <div class="header-content">
          <div class="breadcrumb">
            ...
            <span class="breadcrumb-current">{{ $t("legal.breadcrumb.privacy") }}

</span>
          </div>

          <h1 class="privacy-title">{{ $t("legal.privacy.title") }}

</h1>
          <p class="privacy-subtitle">{{ $t("legal.privacy.subtitle") }}
          ...
          <div class="privacy-main">
            <div class="privacy-card">
              ...
              <section id="introduction" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.introduction.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.introduction.content") }}
              ...
              <section id="information-collection" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.informationCollection.title") }}
                ...
                <div class="section-content">
                  ...
                  <p>{{ $t("legal.privacy.informationCollection.personal.content") }}

</p>
                  <ul class="privacy-list">
                    <li>{{ $t("legal.privacy.informationCollection.personal.name") }}

</li>
                    <li>{{ $t("legal.privacy.informationCollection.personal.email") }}

</li>
                    <li>{{ $t("legal.privacy.informationCollection.personal.profile") }}
                  ...
                  <p>{{ $t("legal.privacy.informationCollection.usage.content") }}

</p>
                  <ul class="privacy-list">
                    <li>{{ $t("legal.privacy.informationCollection.usage.logs") }}

</li>
                    <li>{{ $t("legal.privacy.informationCollection.usage.device") }}

</li>
                    <li>{{ $t("legal.privacy.informationCollection.usage.cookies") }}
              ...
              <section id="information-usage" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.informationUsage.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.informationUsage.content") }}

</p>
                  <ul class="privacy-list">
                    <li>{{ $t("legal.privacy.informationUsage.service") }}

</li>
                    <li>{{ $t("legal.privacy.informationUsage.communication") }}

</li>
                    <li>{{ $t("legal.privacy.informationUsage.improvement") }}

</li>
                    <li>{{ $t("legal.privacy.informationUsage.security") }}
              ...
              <section id="information-sharing" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.informationSharing.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.informationSharing.content") }}
              ...
              <section id="data-security" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.dataSecurity.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.dataSecurity.content") }}

</p>
                  <ul class="privacy-list">
                    <li>{{ $t("legal.privacy.dataSecurity.encryption") }}

</li>
                    <li>{{ $t("legal.privacy.dataSecurity.access") }}

</li>
                    <li>{{ $t("legal.privacy.dataSecurity.monitoring") }}
              ...
              <section id="your-rights" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.yourRights.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.yourRights.content") }}

</p>
                  <ul class="privacy-list">
                    <li>{{ $t("legal.privacy.yourRights.access") }}

</li>
                    <li>{{ $t("legal.privacy.yourRights.correction") }}

</li>
                    <li>{{ $t("legal.privacy.yourRights.deletion") }}

</li>
                    <li>{{ $t("legal.privacy.yourRights.portability") }}
              ...
              <section id="cookies" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.cookies.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.cookies.content") }}

</p>
                  <ul class="privacy-list">
                    <li>{{ $t("legal.privacy.cookies.essential") }}

</li>
                    <li>{{ $t("legal.privacy.cookies.analytics") }}

</li>
                    <li>{{ $t("legal.privacy.cookies.preferences") }}
              ...
              <section id="contact" class="privacy-section">
                <h2 class="section-title">{{ $t("legal.privacy.contact.title") }}

</h2>
                <div class="section-content">
                  <p>{{ $t("legal.privacy.contact.content") }}
                  ...
                  <div class="contact-info">
                    <div class="contact-item">
                      ...
                      <span>{{ $t("legal.privacy.contact.email") }}
    ...
    <div class="privacy-footer">
      <div class="container">
        <div class="footer-cta">
          <h3 class="cta-title">{{ $t("legal.privacy.cta.title") }}
