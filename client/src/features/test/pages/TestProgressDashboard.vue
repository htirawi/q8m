        ...
        <section class="section">
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <div class="stat-value streak">{{ progress.streaks.currentStreak }} days</div>
            </div>
            <div class="stat-card">
              <div class="stat-label">Longest Streak</div>
              <div class="stat-value">{{ progress.streaks.longestStreak }} days</div>
            </div>
            <div class="stat-card">
        ...
        <section class="section">
          ...
          <div class="difficulty-grid">
            <div class="difficulty-card">
              <h3>Easy</h3>
              <p>Mastered: <strong>{{ progress.difficultyProgress.easy.mastered }}</strong></p>
              <p>Familiar: <strong>{{ progress.difficultyProgress.easy.familiar }}</strong></p>
              <p>Learning: <strong>{{ progress.difficultyProgress.easy.learning }}</strong></p>
              <p>New: <strong>{{ progress.difficultyProgress.easy.new }}</strong></p>
            </div>
            <div class="difficulty-card">
              <h3>Medium</h3>
              <p>Mastered: <strong>{{ progress.difficultyProgress.medium.mastered }}</strong></p>
              <p>Familiar: <strong>{{ progress.difficultyProgress.medium.familiar }}</strong></p>
              <p>Learning: <strong>{{ progress.difficultyProgress.medium.learning }}</strong></p>
              <p>New: <strong>{{ progress.difficultyProgress.medium.new }}</strong></p>
            </div>
            <div class="difficulty-card">
              <h3>Hard</h3>
              <p>Mastered: <strong>{{ progress.difficultyProgress.hard.mastered }}</strong></p>
              <p>Familiar: <strong>{{ progress.difficultyProgress.hard.familiar }}</strong></p>
              <p>Learning: <strong>{{ progress.difficultyProgress.hard.learning }}</strong></p>
              <p>New: <strong>{{ progress.difficultyProgress.hard.new }}</strong></p>
            </div>
          </div>
        </section>
      </div>
          ...
          <div class="stats-table">
            <table>
              <tr>
                ...
                <td><strong>{{ Math.round(stats.totalStudyTimeMinutes) }} minutes</strong></td>
              </tr>
              <tr>
                <td>Total Study Sessions</td>
                <td><strong>{{ stats.totalStudySessions }}</strong></td>
              </tr>
              <tr>
                <td>Average Session Duration</td>
                <td><strong>{{ Math.round(stats.averageSessionDurationMinutes) }} minutes</strong></td>
              </tr>
              <tr>
                <td>Questions Attempted</td>
                <td><strong>{{ stats.totalQuestionsAttempted }}</strong></td>
              </tr>
              <tr>
                <td>Questions Correct</td>
                <td><strong>{{ stats.totalQuestionsCorrect }}</strong></td>
              </tr>
              <tr>
