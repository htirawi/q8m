    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            :class="[
              ...
              selectedLevel === quiz.level && canUserAccessLevel(quiz.level)
                ...
                : 'hover:border- border-gray-200' +
                  ...
                  '-400 hover:shadow-xl dark:border-gray-700',
      ...
      <div class="text-center">
        <button
          ...
          class="hover:shadow-3xl group relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-12 py-4 text-lg font-bold text-white shadow-2xl transition-all duration-300 hover:scale-105 disabled:cursor-not-allowed disabled:opacity-50"
          @click="startQuiz"
        >
