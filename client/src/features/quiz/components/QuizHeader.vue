  ...
  <div class="mb-8">
    ...
    <div class="flex items-center justify-between border-b border-gray-100 pb-4 dark:border-gray-800">
      ...
      <div class="flex items-center gap-6">
        <!-- Minimal Timer Only -->
        <div class="flex items-center gap-2 text-sm font-mono" :class="timerTextClass">
          {{ timeFormatted }}
    ...
    <div class="mt-6">
      <div class="mb-3 flex items-center justify-between text-sm">
        <span class="text-gray-600 dark:text-gray-400">Question {{ currentIndex + 1 }} of {{ totalQuestions }}

</span>
        <span class="font-semibold text-gray-900 dark:text-gray-100">{{ Math.round(progress) }}%</span>
      </div>
      <div class="h-1 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700">
        <div class="h-full bg-gradient-to-r from-blue-600 to-purple-600 transition-all duration-500 ease-out"
