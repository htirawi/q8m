    ...
    >
      ...
      >
        ...
        <div class="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          ></div>
          <div
            class="animation-delay-2000 absolute -bottom-4 -right-4 h-32 w-32 animate-blob rounded-full bg-purple-300 opacity-20 mix-blend-multiply blur-xl filter dark:bg-purple-600"
          ></div>
        </div>

        <div class="relative">
          <!-- Animated Emoji -->
          <div class="animate-bounce-slow mb-6 inline-block text-7xl sm:text-8xl">
            {{ resultEmoji }}
          </div>
      ...
      <div class="grid gap-4 p-6 sm:grid-cols-3 sm:p-8">
        ...
        >
          ...
          <div
            class="mb-2 text-4xl font-extrabold tabular-nums text-purple-900 dark:text-purple-200"
          >
            {{ timeFormatted }}
          </div>
          <div
      ...
      <div
        v-if="hasGamificationData && quizResultData"
      ...
      <!-- Action Buttons -->
      <div
        class="border-t border-gray-200 bg-gray-50/50 p-6 dark:border-gray-700 dark:bg-gray-800/50 sm:p-8"
      >
...
const hasGamificationData = computed(
  () => props.quizResultData !== null && props.quizResultData !== undefined
);

const hasXPBreakdown = computed(() => {
  return (
    hasGamificationData.value &&
    props.quizResultData?.xpBreakdown &&
    Object.keys(props.quizResultData.xpBreakdown).length > 0
  );
});
