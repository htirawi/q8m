...
export const API_ENDPOINTS = {
  ...
  payments: {
    ...
    pricing: (currency?: string) =>
      currency ? apiUrl(`payments/pricing/${currency}`) : apiUrl("payments/pricing"),
  ...
  progress: {
    ...
    nextQuestion: (params?: URLSearchParams) =>
      apiUrl(`progress/next-question${params ? `?${params.toString()}` : ""}`),
  ...
  quizResults: {
    ...
    history: (params?: URLSearchParams) =>
      apiUrl(`quiz/results/history${params ? `?${params.toString()}` : ""}`),
    stats: (params?: URLSearchParams) =>
      apiUrl(`quiz/results/stats${params ? `?${params.toString()}` : ""}`),
    weakAreas: (params?: URLSearchParams) =>
      apiUrl(`quiz/results/weak-areas${params ? `?${params.toString()}` : ""}`),
    wrongQuestions: (quizId: string) => apiUrl(`quiz/results/${quizId}/wrong-questions`),
  },
  gamification: {
    badges: (params?: URLSearchParams) =>
      apiUrl(`gamification/badges${params ? `?${params.toString()}` : ""}`),
    ...
    leaderboardByType: (type: string, params?: URLSearchParams) =>
      apiUrl(`gamification/leaderboard/${type}${params ? `?${params.toString()}` : ""}`),
    leaderboardRank: (type: string, params?: URLSearchParams) =>
      apiUrl(`gamification/leaderboard/${type}/rank${params ? `?${params.toString()}` : ""}`),
