...
test.describe('Pricing Page - 3-Card Layout', () => {
  ...
  test('should display plan names from registry', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="plan-card-intermediate"]')).toContainText('Intermediate');
...
test.describe('Checkout Flow', () => {
  ...
  test('should navigate to pricing page with plan query param on paid plan click', async ({ page }) => {
...
test.describe('Accessibility', () => {
  ...
  test('should have keyboard accessibility', async ({ page }) => {
    ...
    const modalVisible = await page.locator('[data-testid="checkout-modal"]').isVisible({ timeout: 1000 }).catch(() => false);
